...
def HHO(objf, lb, ub, dim, SearchAgents_no, Max_iter,trainInput,trainOutput,net):
        ...
        for i in range(0, SearchAgents_no):
            ...
            # -------- Exploitation phase -------------------
                ...
                if (
                    ...
                    if objf(X1,trainInput,trainOutput,net) < fitness:  # improved move?
                        X[i, :] = X1.copy()
                        ...
                        if objf(X2,trainInput,trainOutput,net) < fitness:
                            X[i, :] = X2.copy()
                if (
                    r < 0.5 and abs(Escaping_Energy) < 0.5
